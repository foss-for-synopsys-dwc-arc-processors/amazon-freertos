...
#os definition
OS_ID = OS_AWS_FREERTOS
#os usage settings
COMMON_COMPILE_PREREQUISITES += $(OSES_ROOT_DIR)/aws_freertos/aws_freertos.mk
include $(OSES_ROOT_DIR)/aws_freertos/aws_freertos.mk
